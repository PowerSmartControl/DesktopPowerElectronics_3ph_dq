...
BEGIN DRIVER
 ...
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = phase_generator_pll
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = phase_generator_fp
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = phase_generator_vsi
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = pll_int
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = pll_int_0
END
