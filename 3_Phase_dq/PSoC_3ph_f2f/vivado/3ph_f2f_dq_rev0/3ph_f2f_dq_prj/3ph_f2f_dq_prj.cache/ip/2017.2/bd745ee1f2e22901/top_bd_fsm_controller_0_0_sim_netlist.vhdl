...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_FSM_controller_core is
  ...
  signal \clk_counter[5]_i_3_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \clk_counter[5]_i_2\ : label is "soft_lutpair0";
...
PLL_START_INST_0: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\clk_counter[5]_i_3\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"7FFF"
    )
        port map (
      ...
      I2 => clk_counter_reg(9),
      I3 => clk_counter_reg(7),
      O => \clk_counter[5]_i_3_n_0\
    );
\clk_counter[6]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"AAAA2AAA55555555"
    )
        port map (
...
\clk_counter[9]_i_3\: unisim.vcomponents.LUT6
    generic map(
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_FSM_controller_v1_0_S00_AXI is
  ...
  attribute SOFT_HLUTNM of \slv_reg1[0]_i_3\ : label is "soft_lutpair5";
begin
...
FSM_controller_core0: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_FSM_controller_core
     port map (
      PLL_START => PLL_START,
      \current_state_reg[1]_0\ => FSM_controller_core0_n_0,
