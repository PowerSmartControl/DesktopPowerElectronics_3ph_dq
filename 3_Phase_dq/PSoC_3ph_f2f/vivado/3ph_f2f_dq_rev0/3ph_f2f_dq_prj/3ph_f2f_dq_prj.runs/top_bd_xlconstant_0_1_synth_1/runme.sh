...
HD_PWD='D:/Projects/PSoC_3ph_f2f/vivado/3ph_f2f_dq_rev0/3ph_f2f_dq_prj/3ph_f2f_dq_prj.runs/top_bd_xlconstant_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_bd_xlconstant_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_bd_xlconstant_0_1.tcl
