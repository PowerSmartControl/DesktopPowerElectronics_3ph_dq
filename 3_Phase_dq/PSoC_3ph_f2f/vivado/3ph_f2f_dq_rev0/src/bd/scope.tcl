...
################################################################
# This is a generated script based on design: scope
#
...
CONFIG.DOUT_WIDTH {12} \
  ...
  connect_bd_net -net s_axi_aclk_1 [get_bd_ports s_axi_aclk] [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins blk_mem_gen_0/clka] [get_bd_pins scope_3ph_0/s00_axi_aclk]
  connect_bd_net -net s_axi_aresetn_1 [get_bd_ports s_axi_aresetn] [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins scope_3ph_0/s00_axi_aresetn]
  ...
  create_bd_addr_seg -range 0x00004000 -offset 0x00000000 [get_bd_addr_spaces bram_AXI] [get_bd_addr_segs axi_bram_ctrl_0/S_AXI/Mem0] SEG_axi_bram_ctrl_0_Mem0
  create_bd_addr_seg -range 0x00001000 -offset 0x00000000 [get_bd_addr_spaces scopeCtrl_AXI] [get_bd_addr_segs scope_3ph_0/S00_AXI/S00_AXI_reg] SEG_scope_3ph_0_S00_AXI_reg
